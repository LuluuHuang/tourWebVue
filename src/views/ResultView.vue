    ...
    <div class="row">
      ...
      <div class="col-12 resultContent" v-else>
        <div v-if="store.searchCategory == 'ScenicSpot'" class="row">
          ...
          >
            <p class="ellipsis" style="width: 200px">{{ item.ScenicSpotName }}</p>
            <div class="imgContainer">
              <img
                :src="
                  item.Picture && item.Picture.PictureUrl1 ? item.Picture.PictureUrl1 : photoNoImage
                "
                :alt="
                  item.Picture && item.Picture.PictureDescription1
        ...
        <div v-if="store.searchCategory == 'Activity'" class="row">
          <div
            ...
            @click="store.getDetail(i)"
          >
            <p class="ellipsis" style="width: 200px">{{ item.ActivityName }}</p>
            <div class="imgContainer">
              <img
                :src="
                  item.Picture && item.Picture.PictureUrl1 ? item.Picture.PictureUrl1 : photoNoImage
...
.resultContent {
  ...
  .name:hover {
    .imgContainer {
      box-shadow: #06060626 2px 2px 2.6px;
      img {
