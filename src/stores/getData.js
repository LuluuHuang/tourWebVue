...
export const useDataStore = defineStore('data', () => {
      ...
      mores: [
        {
          ...
          morePic:
            'https://www.travel.taipei/content/images/articles/430767/1024x768_articles-image-rs4d8wbdakadanjiw6ofwa.jpg'
        },
        {
          moreName: '2024竹子湖海芋季及繡球花季',
          morePic:
            'https://ak-d.tripcdn.com/images/1mj4n12000b4ejkck77B2_Z_640_10000_R5.jpg_.webp?proc=autoorient'
        },
        {
          moreName: '2024台北霞海城隍文化節',
          morePic:
            'https://www.travel.taipei/content/images/articles/430752/1024x768_articles-image--p7_8nbigkivpy7mxycgjq.jpg'
        }
      ]
    },
    {
      ...
      mores: [
        {
          ...
          morePic:
            'https://cc.tvbs.com.tw/img/program/upload/2022/08/19/20220819170736-c5fde9f4.jpg'
        },
        {
          moreName: '上吉燒肉-東區燒肉美食餐廳',
          morePic:
            'https://cc.tvbs.com.tw/img/program/upload/2023/04/11/20230411182623-1ceda267.jpg'
        },
        {
          moreName: '隱鍋 台北林森北路店',
          morePic:
            'https://storage.googleapis.com/www-cw-com-tw/article/202212/article-63a3c15276556.jpg'
        }
      ]
    }
  ]
  ...
  const getMore = (item, page) => {
    skipPage.value = page
    axios
      .get(`${BASE_URL}/${item}?%24top=${nowPage.value}&%24skip=${skipPage.value}&%24format=JSON`)
      .then((res) => {
        // console.log(res);
        searchResult.value = res.data
